  ...
  return (
    <div className='flex h-full font-main uppercase text-main-size tracking-main-tracking text-main-color leading-main'>
            ...
            >
              ...
              <div className='flex flex-col gap-[3em]'>
                <div className='flex flex-col gap-[2em]'>
                  ...
                  <div className=''>Reservierungstool</div>
                  <iframe
                    data-testid='embed-iframe'
                    style={{ borderRadius: '12px' }}
                    src='https://open.spotify.com/embed/playlist/7FenBC9EVkaT3TOeqQzCSm?utm_source=generator&theme=0'
                    width='100%'
                    height='352'
                    frameBorder='0'
                    allowFullScreen
      ...
      <img
        ...
        alt='Spin Logo'
        className='fixed lg:static left-0 top-0 pointer-events-none select-none object-contain w-full h-auto lg:w-auto lg:h-full mix-blend-difference lg:mix-blend-normal bg-white lg:bg-transparent'
      />
    </div>
  );
};
